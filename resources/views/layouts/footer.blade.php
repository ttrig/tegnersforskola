<footer class="h-full bg-pink-100 border-t-2 border-tegners-blue">
    <div class="flex flex-col items-center max-w-5xl mx-auto h-auto py-6 space-y-2">
        <x-h2>Tegnérs förskola</x-h2>
        <span>Tegnérgatan 60b, 216 12 Limhamn</span>
        <x-link href="tel:+46769451829">0769-45 18 29</x-link>
        <x-link href="mailto:personal@tegnersforskola.se">personal@tegnersforskola.se</x-link>
        <a href="https://github.com/ttrig/tegnersforskola">
            <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 24 24" style="enable-background:new 0 0 24 24;" xml:space="preserve" width="512" height="512">
                <g>
