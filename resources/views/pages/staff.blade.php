<x-layout>
    <x-h1>Personal</x-h1>
    <section class="flex flex-col md:flex-row justify-between pb-4">
        <article class="md:w-2/3 md:pr-4 space-y-4">
            <x-img src="/images/hej.jpg" class="mx-auto h-64"></x-img>
            <x-h3>Vi som arbetar på Tegnérs förskola:</x-h3>
            <p>
                <strong>Helena Strömberg</strong><br>
            ...
            <p>
                ...
                Jag arbetar som barnskötare på Tegnérs förskola sedan 2017.
                Jag arbetar 90% i barngruppen. Jag är ansvarsperson för Solgruppen.
            </p>
            <p>
                <strong>Gabriella &quot;Gabi&quot; Bergqvist</strong><br>
                Jag är utbildad förskollärare och har varit på Tegnérs förskola
        ...
        <aside class="hidden md:block md:w-1/3 pl-0 lg:pl-12">
            <x-img md src="/images/hej.jpg"></x-img>
        </aside>
    </section>
</x-layout>
